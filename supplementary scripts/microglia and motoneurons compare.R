library(xlsx)
glia <- read.csv("~/GitHub/counts/ALS Mice/compare_new/microglia.csv")
moto <- read.csv("~/GitHub/counts/ALS Mice/compare_new/motoneurons.csv")
...
exp <- read.xlsx(file = "~/GitHub/counts/ALS Mice/experimental/results/tg_1-tg_3/Results edgeR.xlsx", sheetIndex = 2)
x <- read.xlsx(file = "~/GitHub/counts/ALS Mice/motoneurons marker.xlsx", sheetIndex = 1)
